            ...
            <li class="topD">
                <ul class="login">
                    <li><span class="left">用户名:</span> <span style="left">
                        <input type="text" value="${admin.adminName }" name="admin.adminName" id="adminName"/>                       
                    </span></li>
                    <li><span class="left">密    码:</span> 
                        <span style="left">  <input type="password" value="${admin.Apassword }" name="admin.Apassword" id="Apassword"/>  </span>
                    </li>
                    <li><span class="left">验证码:</span> 
                         <span style="left">  <input type="text" value="${imageCode }" name="imageCode" id="imageCode" size="10"/>   </span>
                         <span style="left">
